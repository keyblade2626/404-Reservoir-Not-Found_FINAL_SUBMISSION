...
official_examples_section = r"""## 13. Official Input / Output Examples
...
final_logs_section = r"""## 14. Final Logs
...
print("[OK] ARCHITECTURE.md updated to 4 examples and required JSONL logs")
